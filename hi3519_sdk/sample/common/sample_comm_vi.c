...
combo_dev_attr_t MIPI_1lane_CHN0_SENSOR_OV9734_1M_NOWDR_ATTR =
{
    .devno = 0,
...
//ov6946-ov426
combo_dev_attr_t DC_OV6946_ATTR  =
{
    .devno         = 0,
...
/*
	{
		.mipi_attr =
        {
            DATA_TYPE_RAW_10BIT,//DATA_TYPE_YUV422_8BIT
            HI_MIPI_WDR_MODE_NONE,
            {7,8, 9, 10, 11, -1, -1, -1}
        }
	}
...
VI_DEV_ATTR_S DEV_ATTR_DC_OV6946_1MUX =

{
    ...
    VI_DATA_SEQ_YUYV,   /* The input sequence of the second component(only contains u and v) in BT.*/
...
{
    VI_PIPE_BYPASS_NONE, HI_TRUE, HI_FALSE,
    1280, 720,
    PIXEL_FORMAT_RGB_BAYER_10BPP,
    COMPRESS_MODE_LINE,
    DATA_BITWIDTH_10,
...
VI_PIPE_ATTR_S PIPE_ATTR_DC_OV6946_D1 =    
{
    /* bBindDev bYuvSkip */
    VI_PIPE_BYPASS_NONE,HI_FALSE,HI_FALSE,//HI_FALSE 
    400, 400,
    PIXEL_FORMAT_RGB_BAYER_10BPP,//PIXEL_FORMAT_RGB_BAYER_12BPP,
    COMPRESS_MODE_NONE,
    DATA_BITWIDTH_10,
    HI_FALSE,
    {
...
HI_S32 SAMPLE_COMM_VI_GetComboAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, combo_dev_t MipiDev, combo_dev_attr_t* pstComboAttr)
{
    switch (enSnsType)
    {
            case OV_OV9734_MIPI_1M_30FPS:
            if (0 == MipiDev)
            {   
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_1lane_CHN0_SENSOR_OV9734_1M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else
            {
        ...
        case OV_OV6946_DC_1M_30FPS:  
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &DC_OV6946_ATTR, sizeof(combo_dev_attr_t));
                SAMPLE_PRT("[YDY]ov6946\n");
            break;
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S* pstViDevAttr)
{
    switch (enSnsType)
    {
        ...
        case OV_OV6946_DC_1M_30FPS:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_DC_OV6946_1MUX, sizeof(VI_DEV_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetPipeAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_PIPE_ATTR_S* pstPipeAttr)
{
    ...
    {
        case OV_OV9734_MIPI_1M_30FPS:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_1280x720_RAW12_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;

        case OV_OV6946_DC_1M_30FPS:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_DC_OV6946_D1, sizeof(VI_PIPE_ATTR_S));
            break;
...
/*
HI_S32 Reset_COMM_VI_StartIsp( VI_PIPE ViPipe)
{           
    HI_S32              s32Ret = HI_SUCCESS;

    s32Ret = Reset_MPI_ISP_Init(ViPipe);
...
HI_VOID SAMPLE_COMM_VI_GetSensorInfo(SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    pstViConfig->astViInfo[0].stSnsInfo.s32BusId = 4;
