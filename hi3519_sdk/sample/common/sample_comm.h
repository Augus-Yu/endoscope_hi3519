...
typedef enum hiSAMPLE_SNS_TYPE_E
{
    ...
    OV_OV9734_MIPI_1M_30FPS,
    OV_OV6946_DC_1M_30FPS,
...
HI_S32 SAMPLE_OV9734_COMM_VO_GetDefConfig(SAMPLE_VO_CONFIG_S *pstVoConfig);
HI_S32 SAMPLE_OV9734_COMM_VO_StartVO(SAMPLE_VO_CONFIG_S *pstVoConfig);
HI_S32 SAMPLE_OV6946_COMM_VO_GetDefConfig(SAMPLE_VO_CONFIG_S *pstVoConfig);
