...
SDK_SRCS := $(HI3519_SDK_DIR)/sample/common/sample_comm_vi.c \
            ...
            $(HI3519_SDK_DIR)/sample/common/sample_comm_vdec.c
...
CFLAGS += -std=gnu99
# 传感器选择 (OV6946 / OV9734)
ACTIVE_SENSOR ?= OV6946
CFLAGS += -DACTIVE_SENSOR_$(ACTIVE_SENSOR)
...
CFLAGS += -DSENSOR2_TYPE=SONY_IMX377_MIPI_8M_30FPS_10BIT
CFLAGS += -DSENSOR3_TYPE=SONY_IMX377_MIPI_8M_30FPS_10BIT
CFLAGS += -DSENSOR4_TYPE=SONY_IMX377_MIPI_8M_30FPS_10BIT
